...
def prediccionDeTiempoDeViaje(evento):
    ...
    print("La estimación era", vector[0], "la prediccion", prediccion)
    return "predict" # LA PREDICCIÓN Y LO QUE SEA NECESARIO PARA SABER QUE ES SOBRE UN TIEMPO DE VIAJE
...
def escribirEnKafka(prediccion):
    ...
    mensaje = "Predicción" # DECIDIR EL FORMATO DE LOS MENSAJES CON LAS PREDICCIONES
